...
import es.ucm.fdi.tp.pr5.attt.AdvancedTTTFactoryExt;
import es.ucm.fdi.tp.pr5.connectn.ConnectNFactoryExt;
//import es.ucm.fdi.tp.pr5.ttt.TicTacToeFactoryExt;
import es.ucm.fdi.tp.pr6.remotectrl.GameClient;
import es.ucm.fdi.tp.pr6.remotectrl.GameServer;
		...
		case ATAXX:
			if (dimRows != null && dimCols != null && dimRows == dimCols) {
				...
				if (numAtaxxObstacles == null) {
					...
					gameFactory = new AtaxxFactoryExt(numAtaxxObstacles, true);
				}
			}
			break;
		default:
