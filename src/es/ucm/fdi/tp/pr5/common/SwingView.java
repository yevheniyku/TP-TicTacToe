...
public abstract class SwingView extends JFrame implements GameObserver {
	...
	private void handleTurnChange(Board board, Piece turn) {
		this.turn = turn;
		this.board = board;
		if (this.turn.equals(localPiece))
			this.toFront();
	...
	private void passMoveToCtroller(final Player p) {
		...
		// this is for pr6, in pr5 we just called ctrl.makeMove
